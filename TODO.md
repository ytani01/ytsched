...
**残っている項目: TODO-051・TODO-054・TODO-055・TODO-056・TODO-057。**
これまでに 52 件を決着させた。
...
- **スワイプを指に追従させる。**閾値を超えたら切り替えるだけならこの項目で
  ...
  DOM に持つ」とひと続きになる**。TODO-057 として立てた（2026-08-26）。
  **まずはこの項目で、ゲージの `transition` で代用できるかを見る**
...
**TODO-054 が済んでから着手する。** TODO-054 では、まずゲージの
`transition` で代用できるかを見ることにしてある。それで足りるなら、
この項目は要らない。

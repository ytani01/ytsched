...
**残っている項目: TODO-154,TODO-175,TODO-176。** これまでに 173 件を決着させた。
...
これまでの完了済みに記録されているトークン消費をまとめて、分析して、改善策などをがあれば提案して。
過去のTODOでは、実行条件が異なったりして、必ずしも正確なデータではないかもしれないが、そこには目をつぶる。

分析結果は、docs/ にドキュメントとしてまとめて。
なるべく、要点を簡潔に、どうすべきかがはっきりわかりやすいように書いてください。

---

## TODO-176. ミニカレンダーと月間表示の背景を薄いグレーにする。

カレンダーの中の白い枠は白で塗りつぶす(背景のグレーが見えないようにする)

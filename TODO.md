...
**残っている項目: TODO-071, TODO-085..TODO-086, TODO-106..TODO-108, TODO-111**
これまでに 107 件を決着させた。
...
`id="date"` が重複している。このため、先にあるヘッダーの日付入力欄だけが
更新され、フッターの日付入力欄は古い日付のまま残る。

- [ ] ヘッダーとフッターの日付入力欄に重複しない ID を付ける
- [ ] 週を切り替えたとき、ヘッダーとフッターの両方を表示中の週の月曜に揃える
- [ ] ブラウザテストで週を切り替え、両方の日付入力欄と `#cur_day` が更新されることを確認する

...
**残っている項目: TODO-154・TODO-172。** これまでに 170 件を決着させた。
...
- [ ] 削除日時を予定の枠の中へ入れ、1 件のまとまりを分かるようにする
- [ ] 同じ予定のグループを枠か左の縦線でくくる
- [ ] チェックボックスを大きくし、復活ボタンの隣へ寄せる

いまは削除日時（`版 2 ・ 2026-09-02 09:18:22 に削除`）が予定の枠の外に
あり、上下どちらの予定のものか紛らわしい。グループも見出しの文字だけで
範囲が見えない。チェックボックスは小さく、800px では右端に離れている。

削除日時を短く（年・秒を省く）するのは見送る。

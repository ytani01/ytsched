...
- [ ] `.my-mini-cal-dot` を 6px にする
- [ ] `.my-mini-cal-sq` を 6px にし、塗りをやめて `border: 1px solid #28F` にする

TODO-130 で 5px にしたが、丸と四角の差はまだ小さかった。試作を撮って
比べたところ、塗りと枠の差を付けるのが一番はっきりした。印が 2 つ並んでも
6px + gap 1px + 6px = 13px で、セル幅 24px に収まる。

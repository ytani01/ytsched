...
class SchedData:
    ...
    # main_handler.MainHandler の ``LoadWeekPages`` は既定 4、上限
    # 103 週（前後）。1 リクエストで読む日数は、前後に広げた
    # 週数 * 7 日。上限いっぱい（103 週）だと、前後で
    # ``103 * 2 + 1 = 207`` 週、``207 * 7 = 1449`` 日。
    # ToDo（1 件）を足すと 1450 件で、これが

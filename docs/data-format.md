...
- 1 行の形は、`SchedDataEnt.to_dict()` の内容の先頭に、消した日時
  `trashed_at`（ISO 8601、秒まで。例: `"2026-08-30T14:23:05"`）を
  足したもの

```json
{"trashed_at": "2026-08-30T14:23:05", "sde_id": "3f2a…", "date": "2026-08-20", "time_start": "10:00", "time_end": "11:00", "type": "予定", "title": "会議（重要）", "place": "3F 会議室", "detail": "議題"}
```

- 読み出し・復活する UI は今回は作らない（TODO-086）
